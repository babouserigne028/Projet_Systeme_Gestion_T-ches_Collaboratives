...
export default function ProjetDetailsModal({
  ...
  const tabs = [
    { id: "overview", label: "Apercu", icon: Ic.Eye },
    {
      id: "collaborateurs",
    ...
    {
      id: "taches",
      label: `Taches (${projet.taches?.length || 0})`,
      icon: Ic.Check,
    },
    {
      id: "chat",
          ...
          >
            <div className="p-5 text-center space-y-3">
              ...
              <p className="text-sm text-gray-500">
                Cette action supprimera toutes les taches et les collaborateurs
                associes.
              </p>
            </div>
                ...
                {editing ? (
                  ...
                  <>
                    ...
                    <p className="text-xs text-gray-400 mt-0.5">
                      Cree par {projet.createur_details?.prenom}{" "}
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-5">
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      ...
                      {projet.taches.length > 3 && (
                        ...
                        >
                          Voir toutes les taches ({projet.taches.length})
                        </button>
                      )}
                    </div>
                  </div>
                  ...
                  {projet.collaborateurs?.length > 0 ? (
                    ...
                    <div className="text-center py-6">
                      ...
                      <p className="text-xs text-gray-300 mt-1">
                        Utilisez la recherche ci-dessus pour ajouter des membres
                      </p>
                    </div>
                  )}
                </div>
            ...
            {activeTab === "taches" && (
              <>
                ...
                {projet.taches?.length > 0 && (
                  <div className="flex gap-2">
                    {[
                      ...
                      {
                        id: "a_faire",
                        label: `A faire (${projet.taches.filter((t) => t.statut === "a_faire").length})`,
                      },
                      {
                        id: "termine",
                        label: `Terminees (${projet.taches.filter((t) => t.statut === "termine").length})`,
                      },
                    ].map((f) => (
                      <button
                        key={f.id}
                ...
                <div>
                  <span className="text-xs font-bold text-gray-600 uppercase block mb-2">
                    Liste des taches ({filteredTaches.length})
                  </span>
                    ...
                    <div className="space-y-1.5">
                      {filteredTaches.map((tache) => (
                        ...
                        >
                          ...
                          >
                            {tache.statut === "termine" ? "Termine" : "A faire"}
                          </span>
                          <button
                            type="button"
