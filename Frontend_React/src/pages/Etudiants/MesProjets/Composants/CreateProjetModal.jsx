...
export default function CreateProjetModal({
  ...
  // Collaborateurs : uniquement étudiants et professeurs (pas admin)
  const eligibleUsers = allUsers.filter(
    (u) => u.role === "etudiant" || u.role === "professeur",
  );
  ...
  // Assignation des tâches : uniquement les étudiants parmi les collaborateurs sélectionnés
  const assignableUsers = selectedCollabs.filter((u) => u.role === "etudiant");
        ...
        <div className="p-5 space-y-5">
          ...
          >
            <p className="text-[10px] text-gray-400 mb-2">
              Vous pouvez ajouter des étudiants et des enseignants
            </p>
          ...
          <SectionTitle icon={Ic.Check} title="Tâches" count={taches.length}>
            <p className="text-[10px] text-gray-400 mb-2">
              Les tâches ne peuvent être assignées qu'aux étudiants
            </p>
            {taches.length > 0 && (
